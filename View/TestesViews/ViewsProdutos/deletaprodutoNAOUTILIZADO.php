...
<html>
    <body>
            ...
            <input type="button" value="Deletar pelo ID" onclick="atualizar()">
            <br><br>
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            //Setando os campos
                ...
                document.getElementById("fk_product_size_id").value = myObj.fk_product_size_id;
                    ...
                    //se não conseguir, exibe a mensagem do controller "produto não encontrado"
    ...
    function atualizar(){
      ...
      xhttp.open("POST", "/Controller/DeletaProduto.php", true);
